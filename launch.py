...
__module_name__        = "next_launch"
__module_version__     = "0.1"
__module_description__ = "LaunchLibrary plugin for HexChat"
...
def next_launch(word, wordeol, userdata):
   l = launch()
...
def main():
   hexchat.hook_command("launch", next_launch, "")
